...
class Settings(BaseModel):
    ...
    # LLM model selection
    interaction_agent_model: str = Field(default="gemini-1.5-flash")
    execution_agent_model: str = Field(default="gemini-1.5-flash")
    execution_agent_search_model: str = Field(default="gemini-1.5-flash")
    summarizer_model: str = Field(default="gemini-1.5-flash")
    email_classifier_model: str = Field(default="gemini-1.5-flash")
